...
import at.martimavocado.awesome.config.elements.GuiElementButton
...
class GuiOptionEditorUpdateCheck(
    option: ProcessedOption,
) : GuiOptionEditor(option) {
    ...
    override fun render(
        ...
        val currentVersion = Awesome.MOD_VERSION
